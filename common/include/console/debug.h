...
//group test
const size_t TEST               = Ansi_Green | OUTPUT_ENABLED;
...
const size_t JOIN               = Ansi_White   | OUTPUT_ENABLED;
...
const size_t COWMANAGER         = Ansi_Blue | OUTPUT_ENABLED;
...
const size_t EXCEPTIONAL        = Ansi_Red | OUTPUT_ENABLED;
const size_t EXIT        = Ansi_Red | OUTPUT_ENABLED;
