...
//Terminated -> thread has finished, so it shouldn't be scheduled NOR destroyed yet.
//It's only useful for UserThreads
enum ThreadState
{
...
class Thread
{
  ...
  public:
    ...
    Loader* t_loader_;  // Thread Loader Reference, same as Parent Process Loader Reference
